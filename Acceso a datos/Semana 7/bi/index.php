		...
		<div id="contenedor">
			<div id="formulario">
				...
				<div id="selecciontabla">
					...
					<p>En primer lugar seleccionamos la tabla principal en la que queremos operar</p>
				...
				<h3>3.-Selección de los campos en base a lo que quieres ordenar</h3>
				...
				<div id="seleccionalias">
					...
					<p>Seleccionamos los nombres de columna que queramos que aparezcan (opcional)</p>
