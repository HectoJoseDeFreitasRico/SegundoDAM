    ...
    echo '
        ...
        <section>
            <div id="contienecontenido">';
                ...
                if (isset($_POST['clave']) && $_POST['clave'] == "procesainsertar") {$miformulario->procesainsertar();}
            ...
            echo '
            <a href="?create=' . (isset($_GET['tabla']) ? $_GET['tabla'] : '') . '" id="create"><i class="fa fa-plus" aria-hidden="true"></i></a>
        </div>
        </section>
    ';
} else {
