...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2024 a las 19:51:07
...
CREATE TABLE `asignaturas` (
  `Identificador` int(100) NOT NULL COMMENT '{"titulo":"Identificador","descripcion":"Introduce tu email","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"false","tipodato":"number"}	',
  `idmoodle` int(20) NOT NULL COMMENT '{"titulo":"ID de la asignatura","descripcion":"descripcion","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"true","icono":"fas fa-at","tipodato":"text"}\r\n',
  `nombre` varchar(200) COLLATE utf8mb4_spanish_ci NOT NULL COMMENT '{"titulo":"Nombre asignatura","descripcion":"descripcion","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"true","icono":"fas fa-at","tipodato":"number"}\r\n',
  `shortname` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL COMMENT '{"titulo":"Codigo shortname","descripcion":"descripcion","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"true","icono":"fas fa-at","tipodato":"number"}'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci COMMENT='{"titulo":"Asignaturas","descripcion":"Mantenimiento donde puedes ver las asignaturas de los ciclos","icono":"fas fa-chalkboard-teacher"}';
...
(2, 1, 'Procesos de venta', 'P1-AC1A'),
(3, 2, 'Atencion Sociosanitaria', 'ASPD'),
(4, 11, 'Recursos Humanos', 'T1-AYF-RRHH Resp. Soc. Corpor'),
(5, 12, 'Proceso Integral de la Actividad Comercial', 'T2-AYF-Comun y At cliente'),
(6, 13, 'Comunicacion y Atencion al cliente', 'P2A-AH'),
(7, 29, 'Formacion y orientacion laboral', 'P1-FO1'),
(8, 30, 'Teleasistencia', 'P2-AFI'),
(9, 21, 'Politicas Marketing', 'P2-ACIPM'),
(10, 23, 'Gestion de compras', 'P2-GMQT');
...
CREATE TABLE `entregas` (
  `Identificador` int(20) NOT NULL COMMENT '{"titulo":"Identificador","descripcion":"Introduce tu email","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"false","tipodato":"number"}	',
  ...
  `url` varchar(120) COLLATE utf8mb4_spanish_ci NOT NULL COMMENT '{"titulo":"URL de la practica","descripcion":"En este campo debes introducir la URL del tráiler de la película que quieres puntuar","placeholder":"ej:https://www.youtube.com/watch?v=GFZv8MWvaeoaseq","mascara":"algo","min":"10","deshabilitado":"false","visible":"true","icono":"fab fa-youtube","tipodato":"url","max":"120"}',
  `practica` int(2) NOT NULL COMMENT '{"titulo":"Numero de practica","descripcion":"Introduce el numero de la practica","placeholder":"ej:Introduce un número","mascara":"algo","min":"1","max":"2","deshabilitado":"false","visible":"true","icono":"fas fa-sort-numeric-up","tipodato":"number","max2":"10"}	',
  `epoch` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '{"titulo":"Numero practica","descripcion":"Introduce el número de práctica que vas a subir en esta entrega","placeholder":"ej:Introduce un número","mascara":"algo","min":"1","deshabilitado":"true","visible":"false","tipodato":"text","max":"30","max2":"10000000"}',
  `asignatura` int(20) NOT NULL COMMENT '{"titulo":"Número de la practica","descripcion":"Introduce el codigo de la asignatura","placeholder":"pj:1234","mascara":"algo","min":"1","deshabilitado":"true","visible":"true","tipodato":"number","icono":"fas fa-video","parametroget":"idcurso","FKtabla":"asignaturas","FKclave":"idmoodle","FKmostrar":"nombre"}'
...
INSERT INTO `entregas` (`Identificador`, `email`, `url`, `practica`, `epoch`, `asignatura`) VALUES
(30, 'hjfnogueira@gmail.com', 'https://www.youtube.com/watch?v=_8ylSrn3SJY', 2, '2023-11-13 14:19:02', 2),
(31, 'hjfnogueira@gmail.com', 'https://www.youtube.com/watch?v=RUccfKydLLQ', 6, '2023-11-13 14:27:20', 13),
(33, 'hjfnogueira@gmail.com', 'https://www.youtube.com/watch?v=JpUd4BS7yI0', 9, '2023-11-13 14:28:40', 0),
(34, 'aa@aa.com', 'https://youtu.be/owdqwq9dqS-N2bow?si=X3I49BryasdfJK1D6j7I', 12, '2024-02-04 12:21:33', 30),
(35, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:08:49', 30),
(36, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:08:57', 5),
(37, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:09:34', 13),
(38, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:09:36', 2),
(39, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:09:37', 2),
(40, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:09:39', 2),
(41, 'aa@aa.com', 'ASDF', 111, '2024-02-04 13:09:41', 2);
...
(98, 0, 'adsf', 'asdf', 'fasdf', 'fdasf'),
(99, 0, '//localhost/supercrud/formulario.php?', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWeb...', ''),
(100, 1707034232, '//localhost/supercrud/admin/?tabla=usuarios', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'tabla:usuarios|clave:procesainsertar|usuario:dasf|contrasena:asdf|nombre:sadf|apellidos:fasdf|email:hjfnogueira@gmail.com|nivel:1|'),
(101, 1707041852, '//localhost/supercrud/formulario.php', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', ''),
(102, 1707044352, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(103, 1707045382, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(104, 1707045423, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(105, 1707045928, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(106, 1707045929, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(107, 1707045929, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(108, 1707045947, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(109, 1707045947, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(110, 1707047164, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(111, 1707047330, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(112, 1707047331, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(113, 1707047462, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(114, 1707047486, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(115, 1707047487, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(116, 1707047528, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(117, 1707047579, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(118, 1707047579, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(119, 1707047622, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(120, 1707047952, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(121, 1707047953, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(122, 1707047954, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(123, 1707047954, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(124, 1707047955, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(125, 1707048460, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(126, 1707048545, '//localhost/supercrud/formulario.php?idcurso=14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'idcurso:14|'),
(127, 1707062178, '//localhost/supercrud/admin/?tabla=entregas&delete=32', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'tabla:entregas|delete:32|'),
(128, 1707062193, '//localhost/supercrud/admin/?tabla=entregas&delete=32', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', 'tabla:entregas|delete:32|');
...
(10, 'dasf', 'bbb', 'sadf', 'fasdf', 'hjfnogueira@gmail.com', 1);
...
--
ALTER TABLE `asignaturas`
  MODIFY `Identificador` int(100) NOT NULL AUTO_INCREMENT COMMENT '{"titulo":"Identificador","descripcion":"Introduce tu email","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"false","tipodato":"number"}	', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `entregas`
--
ALTER TABLE `entregas`
  MODIFY `Identificador` int(20) NOT NULL AUTO_INCREMENT COMMENT '{"titulo":"Identificador","descripcion":"Introduce tu email","placeholder":"ej:persona@dominio.com","mascara":"algo","min":"5","deshabilitado":"false","visible":"false","tipodato":"number"}	', AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `informes`
--
ALTER TABLE `informes`
  MODIFY `Identificador` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `registros`
--
ALTER TABLE `registros`
  MODIFY `Identificador` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
