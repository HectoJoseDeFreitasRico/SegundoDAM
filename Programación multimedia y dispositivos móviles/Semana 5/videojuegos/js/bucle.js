...
function bucle(){
	...
	if(isox(posx,posy)+desfasex < mediopantallax){desfasex+=velociaddesfase;}else{desfasex-=velociaddesfase;}
	if(isoy(posx,posy)+desfasey < mediopantallay){desfasey+=velociaddesfase;}else{desfasey-=velociaddesfase;}
	...
	for(var i = 0;i<numeropersonajes;i++){
		...
		var ytemp;
		if(arraypersonajes[i].direccionisometrica == 0){ytemp = 0;}  //0
		if(arraypersonajes[i].direccionisometrica == 1){ytemp = 512;} //512
		if(arraypersonajes[i].direccionisometrica == 2){ytemp = 1024;} //1024
		if(arraypersonajes[i].direccionisometrica == 3){ytemp = 1536;} //1536
		/*Dibujo al personaje*/
		contexto.drawImage(
			imagennpc1,
	...
	contexto.drawImage(
			...
			isoy(posx,posy)+desfasey,128,128);
	/*Dibujo la barra de energia*/
		contexto.fillStyle = "black";
		contexto.fillRect(
